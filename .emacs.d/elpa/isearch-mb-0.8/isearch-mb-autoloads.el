;;; isearch-mb-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn &optional ARG)" t)
(register-definition-prefixes "isearch-mb" '("isearch-"))

;;; End of scraped data

(provide 'isearch-mb-autoloads)
